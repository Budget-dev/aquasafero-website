      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
        ...
        <div className="space-y-16">
          ...
          <div className="grid grid-cols-2 gap-12 pt-12 border-t border-border/50">
            ...
            <div className="space-y-2">
              <div className="text-4xl md:text-6xl font-headline italic">80+</div>
              <div className="text-[10px] tracking-[0.3em] uppercase text-muted-foreground">Global Projects</div>
            </div>
          </div>
        </div>
      </div>
